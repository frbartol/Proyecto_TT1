...
const double SAT_Const::Rad       = pi/180.0;              // Radians per degree
const double SAT_Const::Deg       = 180.0/pi;              // Degrees per radian
const double SAT_Const::Arcs      = 3600*180.0/pi;         // Arcseconds per radian
...
const double SAT_Const::omega_Earth = 15.04106717866910/3600.0*SAT_Const::Rad;   // [rad/s]; WGS-84
...
const double SAT_Const::P_Sol       = 1367.0/SAT_Const::c_light; // [N/m^2] (~1367 W/m^2) IERS 96
